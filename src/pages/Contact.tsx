  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast({ title: "Erreur", description: "Problème d'envoi. Contactez directement contact@epure-db.com", variant: "destructive" });
      }
    } catch {
      toast({ title: "Erreur", description: "Problème réseau. Contactez directement contact@epure-db.com", variant: "destructive" });
    } finally {
      setSending(false);
    }
  };
            ...
            <AnimatedSection className="lg:col-span-3">
              <div className="border border-border bg-gray-50 p-8 h-full">
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  >
                    {sending ? "Envoi..." : "Envoyer"} <ArrowRight className="ml-2" size={18} />
                  </Button>
                </form>
              </div>
            </AnimatedSection>
