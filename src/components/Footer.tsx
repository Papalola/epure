...
const Footer = () => (
  <footer className="py-16 bg-primary text-primary-foreground">
    <div className="container mx-auto px-4 grid md:grid-cols-3 gap-12">
      <div>
        <img src={logoEpureWhite} alt="Épure" className="h-12 mb-4 opacity-80" />
      ...
      <div>
        ...
        <div className="flex flex-col gap-3 text-sm text-primary-foreground/50">
          ...
          <a href="#" className="flex items-center gap-2 hover:text-primary-foreground transition-colors mt-1">
