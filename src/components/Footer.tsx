      ...
      <div className="container mx-auto px-4 py-16 grid md:grid-cols-3 gap-12 items-stretch">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm text-primary-foreground/50">
            ...
            <a href="https://www.linkedin.com/company/epure-db" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary-foreground transition-colors mt-1">
